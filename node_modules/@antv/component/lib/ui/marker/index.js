...
var Marker = /** @class */ (function (_super) {
    ...
    Marker.prototype.render = function (attributes, container) {
        var symbol = attributes.symbol, _a = attributes.size, size = _a === void 0 ? 16 : _a, _b = attributes.x, x = _b === void 0 ? 0 : _b, _c = attributes.y, y = _c === void 0 ? 0 : _c, transform = attributes.transform, transformOrigin = attributes.transformOrigin, style = tslib_1.__rest(attributes, ["symbol", "size", "x", "y", "transform", "transformOrigin"]);
