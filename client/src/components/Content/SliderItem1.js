...
export const sliderItems1 = [
    { title: '#How to wear saris', content: 'This is the first card', video: video },
    { title: '#Latest trends', content: 'This is the first card', video: video2 },
    { title: '#IndoWestern', content: 'This is the first card', video: video4 },
